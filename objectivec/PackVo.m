...
- (void)encode:(PackEncoder * _Nonnull)encoder {
    ...
    [encoder putCDouble:3 withValue:d_column];
...
-(id<Packable>)decode:(PackDecoder *)decoder{
    ...
    t->d_column = [decoder getCDouble:3];
...
- (void)encode:(PackEncoder * _Nonnull)encoder {
    ...
    [encoder putSInt:7 withValue:int_4];
    ...
    [encoder putSInt64:12 withValue:long_4];
